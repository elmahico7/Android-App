...
public class CovidCountryAdapter extends RecyclerView.Adapter<CovidCountryAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvCountyName.setText(covidCountry.getmCovidCountry());
        //Glide
        Glide.with(context).load(covidCountry.getmFlags()).apply( new RequestOptions().override(240, 160)).into(holder.imgCounryFlag);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvTotalCases, tvCountyName;
        ImageView imgCounryFlag;
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvTotalCases = itemView.findViewById(R.id.tvTotalCases);
            tvCountyName = itemView.findViewById(R.id.tvCountryName);
            imgCounryFlag = itemView.findViewById(R.id.imgCountryFlag);
        }
    }
